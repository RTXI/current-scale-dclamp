...
FaberRudy2000::FaberRudy2000(void) {
    ...
    */
    ...
    cout << "**** FaberRudy2000 Model Cell Loaded ****" << endl;
} // End constructor
...
FaberRudy2000::~FaberRudy2000(void) {
    ...
    delete[] coslkup;
    delete[] acoslkup;
    cout << "**** FaberRudy2000 Model Cell Unloaded ****" << endl;
} // End destructor

/*** Current and gating solver ***/
void FaberRudy2000::solve() {
...
double FaberRudy2000::vClamp(double voltage) {
    // Clamp model voltage
    V = voltage;

    solve(); // voltage free to change during solver
...
double FaberRudy2000::iClamp(double current){
...
double FaberRudy2000::current(int current){

    switch(current){
        
    // Currents
    case 0: return I_Total; break;
    case 1: return I_Na_ion_total; break;
    case 2: return I_K_ion_total; break;
    case 3: return I_Ca_ion_total; break;
    case 4: return I_Na; break;
    case 5: return I_Na_b; break;
    case 6: return 3*I_Na_K; break;
    case 7: return 3*I_Na_Ca; break;
    case 8: return I_Ca_Na; break;
    case 9: return I_Kr; break;
    case 10: return I_Ks; break;
    case 11: return I_K1; break;
    case 12: return I_Kp; break;
    case 13: return 2*I_Na_K; break;
    case 14: return I_Ca_K; break;
    case 15: return I_Ca_L; break;
    case 16: return I_Ca_T; break;
    case 17: return I_Ca_b; break;
    case 18: return I_p_Ca; break;
    case 19: return 2*I_Na_Ca; break;
    case 20: return I_Na_ion_total; break;
    case 21: return I_K_ion_total; break;
    case 22: return I_Ca_ion_total; break;
...
double FaberRudy2000::concentration(int concentration){

    switch(concentration){

    case 0: return Na_in; break;
    case 1: return K_in; break;
    case 2: return Ca_in; break;
...
void FaberRudy2000::reset(){ // Reset to initial conditions
    ...
    */
    ...
    cout << "\n**** FaberRudy2000 model reset to initial conditions ****\n";
} // End reset()

QStringList FaberRudy2000::paramList( void ) {
    QStringList list;
